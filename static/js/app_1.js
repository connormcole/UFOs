...
// Create handleClick function for when users click a button
function handleClick() {
    ...
    // Rebuild the table using the filtered data. If no date entered, filteredData will just be the original tableData.
